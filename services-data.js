...
const services = [
  ...
  { id: 'SVC-002', name: 'Name Tape — Creation (No Velcro)', price: 6.00, category: 'creation',
    desc: 'Custom name tape embroidered on OCP-pattern fabric. Sew-on only, no hook-and-loop.',
    tags: ['OCP', 'Custom', 'Sew-On'], time: '10 min' },
