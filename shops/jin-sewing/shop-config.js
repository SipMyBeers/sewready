...
const shopConfig = {
  ...
  address: '3640 Bragg Blvd, Fayetteville, NC 28303',
  phone: '(910) 555-0111',
  email: 'jin@jinsewing.com',
  owner: 'Jin H.',
  themeColors: {
    primary: '#3498db',
    secondary: '#1c2833',
  ...
  story: 'Jin Sewing has earned a reputation for precision and speed. Serving Fort Liberty soldiers with fast turnaround and regulation-compliant work.',
  trustSignals: {
    orders: '500+',
    rating: '4.9'
  },
  enabledServiceIds: null,
  adminPassword: 'frzcep'
};

const employees = [
  { id: 'emp-1', name: 'Jin H.', role: 'Owner', color: '#3498db',
  ...
  { id: 'emp-2', name: 'Hana L.', role: 'Seamstress', color: '#e91e63',
