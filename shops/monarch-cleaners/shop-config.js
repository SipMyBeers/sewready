// ══════════════════════════════════════════════════════════════
//  Monarch Cleaners — Shop Configuration
// ══════════════════════════════════════════════════════════════
...
const shopConfig = {
  ...
  address: '3295 Bragg Blvd, Fayetteville, NC 28303',
  phone: '(910) 555-0108',
  email: 'info@monarchcleaners.com',
  owner: 'Rick A.',
  themeColors: {
    primary: '#8e44ad',
    secondary: '#1a1a2e',
  ...
  story: 'Monarch Cleaners has been a Fort Liberty institution for 25 years. From uniform cleaning to custom embroidery, we deliver premium quality.',
  trustSignals: {
    orders: '500+',
    rating: '4.9'
  },
  enabledServiceIds: null,
  adminPassword: 'zpu3we'
};

const employees = [
  { id: 'emp-1', name: 'Rick A.', role: 'Manager', color: '#8e44ad',
  ...
  { id: 'emp-2', name: 'Helen W.', role: 'Seamstress', color: '#e91e63',
  ...
  { id: 'emp-3', name: 'Paul D.', role: 'Embroidery', color: '#f39c12',
